...
const REMIX_IDEAS = [
    "to try different backgrounds.",
    "to try on virtual makeup.",
    "to generate matching accessories.",
    "to create a lookbook with different styles.",
    "to place yourself in different locations.",
    "to generate a custom clothing pattern.",
];
